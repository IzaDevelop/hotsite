            ...
            <nav className="bg-white dark:bg-neutral-950 border-gray-200 dark:bg-gray-900">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    ...
                    <div onClick={() => setMenu(false)}
                        className={`md:block md:w-auto w-full bg-white dark:bg-neutral-950 ${menu ? "visible absolute top-[100px] right-0" : "hidden"}`}
                    >
                        <ul className="font-medium text-xl flex flex-col p-4 md:p-0 mt-4 border-b border-red bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white md:dark:bg-neutral-950 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                            <li>
                            ...
                            <li>
                                {theme ? (
                                    <button
                                        ...
                                        className="ps-2 lg:ps-0 pt-1 rounded focus:border-0 dark:text-white dark:hover:text-red"
                                    >
                                        <Sun size={23} />
                                    </button>
                                ) : (
                                    <button
                                        type="button"
                                        onClick={handleToggleTheme}
                                        className="ps-2 lg:ps-0 pt-1 rounded focus:border-0 hover:text-red"
                                    >
                                        <Moon size={23} />
                                    </button>
                                )}
